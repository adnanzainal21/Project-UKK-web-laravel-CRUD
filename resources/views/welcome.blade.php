    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark px-4">
            <a class="navbar-brand" href="#">
                ...
                <span id="text-brand" class="text-white">XII PPLG 2 SPANDELA</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu text-white mx-2" href="#benefits">Informatick</a>
                    </li>
                </ul>
            </div>
        </nav>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 px-5">
                        <h1 class="text-primary font-weight-bold text-gradient typing-animation text-title">Welcome to Class XII PPLG 2</h1>
                        <p class="text-secondary animation-text">Sistem informasi kelas XII PPLG 2 2024/2025.</p>
